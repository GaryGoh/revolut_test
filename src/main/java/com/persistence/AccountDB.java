...
public class AccountDB {
    ...
    static {
        accounts.put(1, new Account(1, "FN1", "LN1", "12345","IB12345", new BigDecimal(2000)));
        accounts.put(2, new Account(2, "FN2", "LN2", "342543","IB342543", new BigDecimal(350)));
        accounts.put(3, new Account(3, "FN3", "LN3", "766732","IB766732", new BigDecimal(5000)));
        accounts.put(4, new Account(4, "FN4", "LN4", "98763","IB98763", new BigDecimal(0)));
    }
